...
subplot(1, 2, 1)
hold on
plot(W0u2(1:cross_indices2,6), newtht2(1:cross_indices2)+ 6*pi,'LineWidth', 1) % plotting unwrap angle values
plot(W0u2(1:cross_indices2,6), newtht2(1:cross_indices2)+ 4*pi,'LineWidth', 1) % plotting unwrap angle values
plot(W0u2(1:cross_indices2,6), newtht2(1:cross_indices2)+ 2*pi,'LineWidth', 1) % plotting unwrap angle values
...
subplot(1, 2, 2)
hold on
plot(W0c(1:cross_indices,1), newtht(1:cross_indices)-2*pi,'r','LineWidth', 1)
