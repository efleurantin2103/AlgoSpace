...
if h == length(lambda)-1
    line_color_1 = 'r'; % First line red
    line_color_2 = 'r'; % Second line red
    line_color_3 = 'k'; % Third line black (only the last one)
    line_width_1 = 0.5;
    line_width_2 = 0.5;
    line_width_3 = 3; % Thicker for black
    W0c_last    = W0c;
    newtht_last = newtht;
else
    line_color_1 = 'r';
