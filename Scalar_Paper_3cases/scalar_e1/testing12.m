...
sgtitle('Scenario 1: $V_{1,\varepsilon}(x)=-30\varepsilon^2e^{-(\varepsilon x)^2},$  $V_0(x) = -5e^{-2x}$', 'Interpreter', 'latex', ...
    'FontSize', 20, ...
    'FontWeight', 'bold')

end
%print(2, '-depsc', '-painters', 'scalar1_case1.eps')
print(2, '-depsc', '-painters', 'scalar1_caseV1.eps')
